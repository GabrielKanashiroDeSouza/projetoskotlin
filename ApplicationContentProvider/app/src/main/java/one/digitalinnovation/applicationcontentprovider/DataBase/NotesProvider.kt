...
import one.digitalinnovation.applicationcontentprovider.DataBase.NotesDataBaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    companion object{
        const val AUTHORITY="one.digitalinnovation.applicationcontentprovider.provider"
